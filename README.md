...
A [repo](https://gerrit.googlesource.com/git-repo) manifest: 47 projects across 5 GitHub orgs, plus the checks and the ledger that say whether the work is moving.
